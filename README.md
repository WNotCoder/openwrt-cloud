...
> **适配路由：京东云亚瑟（RE-SS-01），需提前刷好大分区。其他路由未来可能会支持**
...
>我的考虑：
**主路由就不应该承担无线网络功能。**
路由无线一体机在很多年前家里只有一两个设备需要用无线的时候，是符合现实情况的。但是到了现在,连家里温度计都要连WiFi的年代，一体机又要处理路由数据，还要协调一堆无线设备，对于CPU性能的要求就更高了。相应成本就高。
我的解决方案是把主路由和无线解耦，主路由只负责路由功能，无线用专用的无线设备去做。得益于运营商大批量的上马OTTR，现在闲鱼上支持mesh的无线AP价低量大。这个方案完全是可行的。比单独买一台路由性能、无线性能都强的设备要便宜很多。
